...
$(window).scroll(function() {
if ($(this).scrollTop() > 1){
$('.header_center_logo').addClass("animated fadeOut");
}
else{
$('.header_center_logo').removeClass("animated fadeOut");
}
...
$(".toggle_mnu").click(function() {
 ...
 $(".add-to-cart").click(function() {
	$(".lable1").removeClass("fadeOutUp animated").addClass("fadeInDown animated");
	setTimeout(function(){$('.lable1').removeClass("fadeInDown animated").addClass("fadeOutUp animated")},1400);
 });